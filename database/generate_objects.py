# THIS FILE HOLDS THE FUNCTIONS THAT GENERATE THE PRODUCT, CATEGORY, SAVED_PRODUCT and USER OBJECTS TO BE INSERTED IN
# THE DATABASE
...
from database.create_tables import Product, Category, User, Saved_Product
...
def generate_saved_product(user, product_to_replace, healthier_selected_product):
    """
        This function creates a Saved_Product object with a specified product to replace and healthier product
